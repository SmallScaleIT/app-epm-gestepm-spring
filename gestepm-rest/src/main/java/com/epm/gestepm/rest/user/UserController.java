...
public class UserController extends BaseController implements UserV1Api,
    ...
    public ResponseEntity<ListUsersV1200Response> listUsersV1(final List<String> meta, final Boolean links, final Set<String> expand, final Long offset, final Long limit, final String order, final String orderBy,
                                                              ...
                                                              final List<Integer> states, final List<Integer> signingIds, final List<Integer> roleIds, final List<Integer> levelIds, final Integer leadingProjectId, final Integer memberProjectId) {

        final UserListRestRequest req = new UserListRestRequest(ids, nameContains, email, password, activityCenterIds, states, signingIds, roleIds, levelIds, leadingProjectId, memberProjectId);
