...
public interface ResponsesForCountry {
  ...
  default ResponseEntity<CreateCountryV1200Response> toCountryResponse(Country data) {
  ...
  default ResponseEntity<CreateCountryV1200Response> toCountryResponse(APIMetadata metadata, Country data) {

    if (metadata == null) {
      return toCountryResponse(data);
    }
  ...
  default ResponseEntity<CreateCountryV1200Response> toCountryResponse(APIMetadata metadata, Country data,
    ...
    if (etag == null) {
      return toCountryResponse(metadata, data);
    }
