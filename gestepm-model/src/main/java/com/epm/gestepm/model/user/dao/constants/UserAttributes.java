package com.epm.gestepm.model.user.dao.constants;

public class UserAttributes {

    public static final String ATTR_U_ID = "attr_u_id";

    public static final String ATTR_U_IDS = "attr_u_ids";
    ...
    public static final String ATTR_U_SIGNING_ID = "attr_u_signing_id";

    public static final String ATTR_U_FORUM_USERNAME = "attr_u_forum_username";

    public static final String ATTR_U_FORUM_PASSWORD = "attr_u_forum_password";
