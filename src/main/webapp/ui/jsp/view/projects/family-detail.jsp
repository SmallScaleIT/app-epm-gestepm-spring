        ...
        <div class="row m-0">
                ...
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1 class="text-uppercase">
                            <spring:message code="families.project.edit.title" />
                        </h1>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="float-right calendarBtns">
                    <a href="/projects/${currentProject.id}/families" class="btn btn-standard btn-sm">
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <div style="font-size: 12px">${currentProject.name}</div>
                                    <div style="font-size: 11px">
                                        <spring:message code="families.project.edit.title.sub" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="createFamilyForm">
                                <div class="row">
                                    <div class="col">
                                        <span><spring:message code="families.project.create.info.title" /></span>
                                    </div>
                                </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="familyId" required>
                                                <c:forEach items="${notFamilies}" var="notFamily">
                                                    <c:choose>
                                                        <c:when test="${notFamily.id == family.family.id}">
                                                            <option value="${notFamily.id}" selected>
                                                                <c:choose>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label class="col-form-label w-100" style="font-size: 12px"><spring:message code="project.detail.equipments.brand"/>
                                                <input name="brand" type="text" class="form-control form-control-sm" id="familyBrandInput" value="${family.brand}">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label class="col-form-label w-100" style="font-size: 12px"><spring:message code="project.detail.equipments.model"/>
                                                <input name="model" type="text" class="form-control form-control-sm" id="familyModelInput" value="${family.model}">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label class="col-form-label w-100" style="font-size: 12px"><spring:message code="project.detail.equipments.enrollment"/>
                                                <input name="enrollment" type="text" class="form-control form-control-sm" id="familyEnrollmentInput" value="${family.enrollment}">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                            ...
                                            <label class="custom-control-label mr-3 w-100" for="customControlInline" style="font-size: 12px"><spring:message code="families.admin.create.common" /></label>
                                        </div>
                                    </div>
                                </div>
...
<script>
	...
	$(document).ready(function() {
		...
		$('#submit').click(function () {
			...
			if (validateForm()) {
				...
				$.ajax({
					url: endpoint + '/families/${family.id}/edit',
					type: 'PUT',
	...
	function initializeSelects() {
        // # CreateForm
        const createForm = document.querySelector('#createFamilyForm');

        createBasicSelect2($(createForm.querySelector('[name="familyId"]')), 'createFamilyForm');
    }
