        ...
        <div class="card-body">
            ...
            <form id="editForm" class="needs-validation">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4">
                        <div class="form-group">
                            <label class="col-form-label pb-0"><spring:message code="customer.signature" /></label>
                            <div class="signature-pad customer-signature">
                                <div class="signature-pad--body">
                                    <canvas class="signature-canvas"></canvas>
                                </div>
                                <div class="signature-pad--footer">
                                    <div class="description"><spring:message code="customer.signature" /></div>
...
<script>
    ...
    $(document).ready(function() {
        initializeSelects();
        loadSignatures('${programmedShare.customerSignature}', '${programmedShare.operatorSignature}');
        loadFiles(files);
        initialize();
        save();
        loadDataTables();
    ...
    function save() {
        ...
        editBtn.click(async () => {
            ...
            if (!isValidForm('#editForm')) {
                ...
                const secondTechnicalId = editForm.querySelector('[name="secondTechnicalId"]').value;
                ...
                let data = {
                    ...
                    startDate: startDate,
                    endDate: endDate,
                    secondTechnicalId: secondTechnicalId,
    ...
    function deleteFile(file, btn, link) {
        const alertMessage = messages.shares.programmed.files.delete.alert.replace('{0}', file.name);
        if (confirm(alertMessage)) {

            showLoading();

            axios.delete('/v1/shares/programmed/${programmedShare.id}/files/' + file.id).then(() => {
    ...
    function setReturnButtonUrl() {
        let lastPageUrl = '/shares/programmed';
